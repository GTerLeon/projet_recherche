...
_C.DATASET_PATHS.FACEBOOK_LARGE = 'data/immutable/facebook_large/musae_facebook.attr'
...
def verify_config(cfg):
    ...
    assert cfg.DATASET in ['rice', 'twitter', 'synthetic', 'facebook_large']
    assert cfg.TASK in ['linkpred', 'infmax', 'nodeclass', 'moonwalk', 'all']
    assert cfg.GRAPH_WEIGHTING.METHOD in ['crosswalk', 'fairwalk', 'moonwalk', 'skip']
    assert cfg.RUNS > 0
